<html>
	...
	<body>
        ...
        <?php
		$consulta2	= "UPDATE immoble SET visites=visites+1 WHERE id=?";
		$statement2  = $con->prepare($consulta2);
        $statement2->execute(array($x));
			...
			if (!$statement) {
				...
				foreach ($statement as $valor) {
					echo '<div class="container finalcontainer">';
                        ...
                        echo '<div class="row filaregis vp_direccio">';
							echo '<div class="col-sm infotab">';
								echo 'DISTRICTE: '.$valor["districte"];
							echo '</div>';
						echo '</div>';
						echo '<div class="row">';
							echo '<div class="col-sm vp_titol">';
                        ...
                        echo '<div class="row filaregis vp_direccio">';
							echo '<div class="col-sm infotab">';
                            echo 'ORIENTACIÓ: '.$valor["orientacio"];
							echo '</div>';
						echo '</div>';                    
						echo '<div class="row">';
							echo '<div class="col-sm vp_titol">';
                        ...
                        echo '<div class="row filaregis">';
                            echo '<div class="col-sm infotab">';
                                if($valor["anunci"]==1){
                                    echo 'Lloguer';
                                } else if($valor["anunci"]==2){
                                    echo 'Venda';
                                } else if($valor["anunci"]==3){
                                    echo 'Lloguer i Venda';
                                }
                            echo '</div>';
                        echo '</div>';	
                        echo '<div class="row">';
                            echo '<div class="col-sm vp_titol">';
                                echo '<legend>DATA REGISTRE</legend>';
                            echo '</div>';
                        echo '</div>';		
                        echo '<div class="row filaregis">';
                            echo '<div class="col-sm infotab">';
                                echo $valor["data_registre"];
                            echo '</div>';
                        echo '</div>';
                        echo '<div class="row">';
                            echo '<div class="col-sm vp_titol">';
                                echo '<legend>USUARI</legend>';
                            echo '</div>';
                        echo '</div>';		
                        echo '<div class="row filaregis">';
                            echo '<div class="col-sm infotab">';
