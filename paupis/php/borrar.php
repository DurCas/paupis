<html>
	...
	<body>
        ...
        <form action="borrar_exit.php" method='post'>
            <div class="vp_direccio">Estas segur de voler borrar el següent pis?</div>
            <input type="hidden" name="id" value=<?php echo $x  ?>>
            <button type="submit" class="btn btn-enviar btn-modal btn-modal-enviar">SÍ</button>
            <!--<button type="submit" name="id" value="<?php echo $x  ?>" class="btn btn-enviar btn-modal btn-modal-enviar">SÍ</button>-->
        </form>
